BUSINESS AUTOMATION - FRONTEND ASSIGNMENT
...
- Build a frontend project using `React` and `TypeScript`,
- Choose any UI library you prefer — `shadcn` could be a good option
- Feel free to use any supporting libraries of your choice
- Follow modern frontend development best practices and industry standards
- Use any architecture approach you prefer — Feature-Sliced Design is recommended
- Be creative and provide a useful UI
- Test coverage is expected


We expect you to return a link to a GitHub repository with:
...
- Include a section describing possible backend improvements
- Include a section outlining what you would enhance in your solution if you had more time
